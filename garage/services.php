	    ...
	    <div class="content">
	    	...
	    	<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3>Interior</h3>
						 <div>
						  <a href="paymentm.php" class="button">Interior</a>
						  </div>
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  <h3>Repair</h3>
						  <div>
						  <input type="button" class="button" value="Repair">
						  </div>
			...
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3>Paper Work</h3>
						 <div>
						  <input type="button" class="button" value="Paper Work">
						  </div>
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  <h3>Replace Parts</h3>
						   <div>
						  <input type="button" class="button" value="Replace Parts">
						  </div>
			...
			<div class="section group">
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h3>Re Sales Services</h3>
						 <div>
						  <input type="button" class="button" value="Re Sales Services">
						  </div>
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  <h3>Tyre Services</h3>
						   <div>
						  <input type="button" class="button" value="Tyre Services">
						  </div>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4"> 
				    <div class="heading-desc">
						<p>Do you want to Service your vehicle or are there any issues with the vehicle you want to solve? Register here.</p>
