				  ...
				  <div class="contact-form">
					    <form method="post" action="reg1.php">
						    ...
						    <div>
						    	...
						    	<span><input name="userPhone" type="tel" class="textbox" maxlength= "10"></span>
						    </div>
						     <div>
						     	<span><label>password</label></span>
						    	<span><input name="pass" type="tel" class="textbox" maxlength= "10"></span>
						    </div>
						    <div>
						    	<span><label>Vehicle name</label></span>
						    	<span><input name="vname" type="text" class="textbox"></span>
						    </div>
						    <div>
						    	<span><label>Vehicle no</label></span>
						    	<span><input name="vno" type="text" class="textbox" maxlength= "10"></span>
						    </div>
							 <div>
						    	<span><label>Issue with the car</label></span>
						    	<span><input name="issue" type="text" class="textbox"></span>
						    </div>
						   <div>
